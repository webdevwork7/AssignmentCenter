  ...
  const allServices = [
    {
      ...
      description:
        "Professional essay writing for all academic levels with perfect structure, compelling arguments, and proper citations.",
    ...
    },
    {
      ...
      description:
        "In-depth research papers with comprehensive analysis, multiple credible sources, and proper methodology.",
    ...
    },
    {
      ...
      description:
        "Complete thesis and dissertation assistance from proposal to defense with expert guidance.",
    ...
    },
    {
      ...
      description:
        "Comprehensive assignment support across all subjects with step-by-step solutions and explanations.",
    ...
    },
    {
      ...
      description:
        "Expert help with mathematical problems, statistical analysis, and data interpretation using advanced tools.",
    ...
    },
    {
      ...
      description:
        "Complete online course assistance including assignments, quizzes, discussions, and exam preparation.",
  ...
  const processSteps = [
    {
      ...
      description:
        "Fill out our simple order form with your assignment details, deadline, and specific requirements.",
      color: "from-purple-500 to-purple-600",
    },
    {
      step: "02",
      ...
      description:
        "We match your project with the most qualified expert in your subject area and academic level.",
      color: "from-pink-500 to-pink-600",
    },
    {
      step: "03",
      ...
      description:
        "Receive your completed assignment on time with free plagiarism report and quality assurance.",
      color: "from-blue-500 to-blue-600",
    },
    {
      step: "04",
      ...
      description:
        "Request unlimited revisions until you're completely satisfied with the quality of work.",
      color: "from-green-500 to-green-600",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              support across all subjects and academic levels with guaranteed
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {processSteps.map((step, index) => (
              <Card
                key={index}
                className="text-center bg-white/80 backdrop-blur-sm border-0 hover:shadow-lg transition-shadow"
              >
                <CardContent className="p-8">
                  <div
                    className={`w-16 h-16 rounded-full bg-gradient-to-r ${step.color} flex items-center justify-center text-white text-2xl font-bold mx-auto mb-6`}
                  >
                    {step.step}
                  </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center bg-gradient-to-br from-purple-50 to-pink-50 border-0">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  PhD qualified writers with extensive academic experience
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center bg-gradient-to-br from-blue-50 to-green-50 border-0">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">
                  Plagiarism-free content with detailed reports
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center text-white relative z-10">
          ...
          <p className="text-xl text-green-100 mb-12 leading-relaxed max-w-3xl mx-auto">
            ...
            our expert help. Get started today and experience the difference
            quality makes.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              className="bg-yellow-400 hover:bg-yellow-500 text-green-900 px-8 py-4 text-lg font-semibold shadow-lg"
            >
              Get Free Quote
            </Button>
          </div>
