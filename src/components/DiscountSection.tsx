      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        <div className="text-center text-white">
          ...
          <h2 className="text-4xl lg:text-6xl font-bold mb-6">
            ...
            <br />
            on Every Second Assignment Help Order!
          </h2>

          <p className="text-xl text-purple-100 mb-12 max-w-3xl mx-auto leading-relaxed">
            Take advantage of our special offer and save on multiple orders.
            Quality academic help has never been more affordable!
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white text-yellow-300 hover:bg-white hover:text-purple-600 px-8 py-4 text-lg font-semibold"
            >
              Learn More
            </Button>
          </div>
