...
import { BookOpen, FileText, GraduationCap, PenTool, Calculator, Globe, ArrowRight, CheckCircle, Phone } from 'lucide-react';
  ...
  const services = [
    {
      ...
      description: "Professional essay writing for all academic levels with perfect structure and compelling arguments.",
      price: "Starting from $15",
      features: ["Original Content", "Free Revisions", "APA/MLA Format", "24/7 Support"],
    ...
    },
    {
      ...
      description: "Complete thesis and dissertation assistance from proposal to defense.",
    ...
    },
    {
      ...
      description: "Comprehensive assignment support across all subjects with step-by-step solutions.",
    ...
    },
    {
      ...
      description: "Expert help with mathematical problems and statistical analysis using advanced tools.",
    ...
    },
    {
      ...
      description: "Complete online course assistance including assignments, quizzes, and discussions.",
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            From essays to dissertations, we provide comprehensive academic support with guaranteed quality.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => {
            ...
            return (
              <Card key={index} className="group relative bg-gradient-to-br from-white to-gray-50/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-0 p-1 rainbow-border">
                <div className="bg-white rounded-lg p-6 h-full">
                  ...
                  <CardHeader className="text-center pb-4">
                    <div className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${service.color} flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 rounded-3xl p-8 lg:p-12 text-white">
            ...
            <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
              We offer custom solutions for unique academic requirements. Contact us to discuss your specific needs.
            </p>
